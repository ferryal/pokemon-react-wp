                  ...
                  <div className="info__container__data__type">
                    {category.map((dataCategory) => (
                      <Tooltip
                        ...
                        key={dataCategory.type.name}
                        title={dataCategory.type.name}
                        arrow
                      >
                        <div
                          key={dataCategory.type.name}
                          className={`poke__type__bg ${dataCategory.type.name}`}
                        >
                          <img
                            src={`/images/${dataCategory.type.name}.png`}
                            alt="poke-type"
                          />
                        </div>
                      </Tooltip>
                        ...
                        {evoChain.map((value, index, elements) => (
                          ...
                          >
                            <div className="evolution__sub__box">
                              ...
                              {elements[index + 1] && (
                                <ArrowRightAltIcon className="arrow__right" />
                              )}
                            </div>
                          </Delayed>
                        ))}
